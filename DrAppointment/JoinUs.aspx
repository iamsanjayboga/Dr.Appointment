        ...
        <div class="wrapper wrapper--w780">
            <div class="card card-3">
                ...
                <div class="card-body">
                    ...
                    <div class="input-group">
                        <asp:RegularExpressionValidator id="emailvalidate" runat="server" ErrorMessage="Invalid Email" ControlToValidate="email" ></asp:RegularExpressionValidator>
                        <asp:TextBox ID="email" class="input--style-3" ClientIDMode="Static" placeholder="email" runat="server"></asp:TextBox>
                        <%--<input class="input--style-3" type="email" placeholder="Email" name="email">--%>
                    </div>
                    <div class="input-group">
                        <asp:RequiredFieldValidator runat="server" ID="phonevalidator" ControlToValidate="phone" ErrorMessage="Phone No Mandatory"></asp:RequiredFieldValidator>
