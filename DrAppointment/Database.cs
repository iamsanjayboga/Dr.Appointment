...
namespace DrAppointment
{
    public class Database
    {
        ...
        //SqlConnection con = new SqlConnection("data source=DESKTOP-KHST74Q; Initial Catalog = CarrerEngine; Trusted_Connection = True;");
        SqlConnection con = new SqlConnection("data source=SANJAYBOGA; Initial Catalog = DrAppointment; Trusted_Connection = True;");
